...
<p align="center">
  <a href="https://doi.org/10.5281/zenodo.22463320"><img src="https://img.shields.io/badge/Research%20DOI-10.5281%2Fzenodo.22463320-0284C7?style=for-the-badge&logo=doi&logoColor=white" alt="Version 2.1 DOI" /></a>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Sealed--75%20Holdout-75%2F75%20(100%25)-10B981?style=flat-square" alt="Sealed-75 Score" />
  <img src="https://img.shields.io/badge/Adaptive%20Red--Team-375%2F375%20(100%25)-10B981?style=flat-square" alt="Adaptive Red Team" />
...
> 
> The Mastyf Security Gateway treats the LLM as an untrusted principal and enforces authorization at the execution boundary using deterministic capability-based access control (CBAC), explicit-flow information-flow controls (DIFC), and deterministic arbitration.  
> 
> **AIA cannot create or expand authority.** A permissive semantic auditor can never override an underlying deterministic CBAC or DIFC denial. The final execution decision is enforced by the reference monitor.  
> 
...
> * **Research Status:** **Frozen Confirmatory Checkpoint**
...
@article{das2026mastyfguard,
  title={Capability-Mediated Perimeters for Secure AI Agent Tool Execution: Counterfactual Boundary Sharpening and Empirical Invariant Evaluation},
  author={Das, Rudraneel},
  journal={arXiv preprint},
  year={2026},
  doi={10.5281/zenodo.22463320},
  note={Hugging Face: Rudraneel93/mastyf-guard-1.5b-v2-boundary-sharpened (Frozen V6 Checkpoint: d59a6aa01f9139dff106146addb04109afa69c03)}
}
```
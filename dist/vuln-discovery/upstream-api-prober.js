 ...
 */
import { isTargetAuthorized, checkProbeRateLimit, auditProbe, isVulnDiscoveryEnabled, } from './auth.js';
...
function persistFinding(partial) {
...
export async function probeUpstreamApi(baseUrl) {
    const findings = [];
    const errors = [];
    let probesRun = 0;
...
export async function probeUpstreamApis(urls) {
    const out = [];
...
//# sourceMappingURL=upstream-api-prober.js.map
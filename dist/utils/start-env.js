...
export function applyProxyRuntimeDefaults() {
    const defaults = {
...
export function applyStartEnv(overrides) {
...
export function resolveStartPolicy(installRoot) {
...
export function isDashboardSpaBuilt(installRoot) {
    return existsSync(join(installRoot, 'deploy', 'dashboard-spa', 'out', 'index.html'));
}
//# sourceMappingURL=start-env.js.map
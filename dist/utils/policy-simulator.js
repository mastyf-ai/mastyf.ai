...
import { simulatePolicyCounterfactual } from '../ai/policy-counterfactual.js';
import { runMastyfAiBenchScorecard } from './mastyf-ai-bench.js';
function draftPolicyForDiff(yaml) {
    return {
        yaml,
        confidence: 0,
...
//# sourceMappingURL=policy-simulator.js.map
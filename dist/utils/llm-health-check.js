...
export function startLlmHealthCheck(intervalMs = DEFAULT_INTERVAL_MS) {
...
export function stopLlmHealthCheck() {
    if (pollTimer) {
...
export function isLlmHealthy() {
    return consecutiveFailures < MAX_CONSECUTIVE_FAILURES;
}
//# sourceMappingURL=llm-health-check.js.map
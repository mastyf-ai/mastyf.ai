export async function handleDashboardThreatDiscoveryRoutes(params) {
    const { url, method, req, res, requestTenantId, writeJson, readBody, setCors, assertFeature, } = params;
    ...
    if (url === '/api/threat-discovery/threat-lab/run' && method === 'POST') {
        ...
        const mode = body.mode === 'proactive' ? 'proactive' : 'reactive';
...
//# sourceMappingURL=dashboard-threat-discovery-routes.js.map
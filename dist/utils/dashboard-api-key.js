...
export function dashboardApiKeyPath(home = process.env.MASTYF_HOME) {
    const root = (home && home.trim()) || join(homedir(), '.mastyf');
    return join(root, 'dashboard_api_key');
}
export function readDashboardApiKeyFile(home) {
...
export function ensureLocalDashboardApiKey() {

...
export function generateSamlRequestUrl(config) {
...
export async function parseSamlResponse(samlResponse, config, expectedRelayState) {
    try {
...
function deflateAndEncode(input) {
    try {

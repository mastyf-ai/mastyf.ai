...
export const HELP_TOOLTIPS = {
    ...
    'protection.block-rate': {
        ...
        detailed: 'The block rate indicates how many autonomous tool requests violated your active security policies. ' +
    ...
    'protection.threat-feed': {
        ...
        detailed: 'Displays intercepted actions in real time, identifying the targeted MCP server, the specific tool called, ' +
    ...
    'protection.top-rules': {
        ...
        detailed: 'Shows which specific security constraints (e.g. path traversal, SQL exfiltration, shell injection) ' +
    ...
    'servers.fleet-overview': {
        ...
        detailed: 'Each card represents an isolated MCP daemon (e.g., filesystem, github, postgres) connected to your AI agents. ' +
    ...
    'servers.threat-score': {
        ...
        detailed: 'Calculated continuously from: block frequency (40%), critical exploit severity (30%), ' +
    ...
    'servers.tool-risk-tier': {
        ...
        detailed: 'Tools with read-only side effects (e.g. search, list, get) are classified as Safe/Low. ' +
    ...
    'policy.enforcement-mode': {
        ...
        detailed: '• AUDIT: Logs all actions without blocking anything (recommended for Week 1 exploration).\n' +
    ...
    'policy.hot-reload': {
        ...
        detailed: 'Edit your YAML policy rules either in the UI editor or via source control. ' +
    ...
    'threat-lab.ai-discoveries': {
        ...
        detailed: 'Threat Lab continuously monitors borderline traffic and proposes novel test cases ' +
    ...
    'cost.token-budgets': {
        ...
        detailed: 'Set strict token limits per call, per hour, or per tenant. ' +
    ...
    'security.eval-playground': {
        ...
        detailed: 'Executes verified attack payloads against your live policy engine to measure detection accuracy ' +
 ...
 */
export function getHelpTooltip(id) {
...
//# sourceMappingURL=help-tooltips.js.map